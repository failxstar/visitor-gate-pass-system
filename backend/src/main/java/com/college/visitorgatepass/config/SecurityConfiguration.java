    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/visitors/request").permitAll()
                        .requestMatchers("/api/visitors/hosts").permitAll()
                        .requestMatchers("/api/passes/track/**").permitAll()
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/passes").permitAll()
                        ...
                        .requestMatchers("/api/events/pass/**").permitAll()
                        .requestMatchers("/api/visitors/host/**").hasAnyRole("HOST", "ADMIN")
